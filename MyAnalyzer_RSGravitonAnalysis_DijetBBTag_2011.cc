...
MyAnalyzer::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   fillVariableWithValue( "MET", MET->front(), eventWeight );
   fillVariableWithValue( "MET_bbbar", getVariableValue("MET"), eventWeight );
   fillVariableWithValue( "SumET", SumET->front(), eventWeight );
   fillVariableWithValue( "SumET_bbbar", getVariableValue("SumET"), eventWeight );
   ...
   {     
     ...
     fillVariableWithValue( "absDeltaEtaJ1J2", fabs( jet1.Eta() - jet2.Eta() ), eventWeight );
     ...
     fillVariableWithValue( "DeltaPhiJ1J2", fabs( jet1.DeltaPhi(jet2) ), eventWeight );
     fillVariableWithValue( "DeltaPhiJ1J2_bbbar", getVariableValue("DeltaPhiJ1J2"), eventWeight );
     
     // calculate M_jj
     dijet = jet1 + jet2;
     
     fillVariableWithValue( "DijetMass", dijet.M(), eventWeight );
